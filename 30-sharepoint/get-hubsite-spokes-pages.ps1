...
$hubSites = @(
    "b80f09f2-c5e5-4f69-9944-33e8fe18a96c",
    "6221ec92-dbe8-4a0a-b533-3f9cdf5bbc13"
...
$workdir = $env:WORKDIR
$workdir = Join-Path $workdir "hubsites"
...
foreach ($HubSiteId in $hubSites) {
    ...
    ConvertTo-Json  -InputObject $reportData -Depth 10
    | Out-File -FilePath (join-path $reportHub  "hubsite-spokes-pages.json") -Encoding:utf8NoBOM
