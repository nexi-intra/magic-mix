...
CREATE OR REPLACE FUNCTION proc.create_sessionstage(
...
BEGIN
    ...
    INSERT INTO public.sessionstage (
    id,
    created_at,
    updated_at,
        created_by, 
    ...
    RETURNING id INTO v_id;
       ...
       p_auditlog_params := jsonb_build_object(
        'tenant', '',
        'searchindex', '',
        'name', 'create_sessionstage',
        'status', 'success',
        'description', '',
        'action', 'create_sessionstage',
        'entity', 'sessionstage',
        'entityid', -1,
        'actor', p_actor_name,
        'metadata', p_params
