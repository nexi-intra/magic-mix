...
CREATE OR REPLACE FUNCTION proc.delete_magicbutton(
...
BEGIN
    ...
    IF v_hard THEN
     DELETE FROM public.magicbutton
        WHERE id = v_id;
    ...
    END IF;
        ...
        'tenant', '',
        'searchindex', '',
        'name', 'delete_magicbutton',
        'status', 'success',
        'description', '',
        'action', 'delete_magicbutton',
        'entity', 'magicbutton',
        'entityid', -1,
        'actor', p_actor_name,
        'metadata', p_params
