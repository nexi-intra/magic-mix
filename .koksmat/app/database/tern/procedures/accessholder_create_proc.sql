...
CREATE OR REPLACE PROCEDURE proc.create_accessholder(
...
BEGIN
    ...
    INSERT INTO public.accessholder (
    id,
    created_at,
    updated_at,
        created_by, 
    ...
    RETURNING id INTO p_id;
       ...
       p_auditlog_params := jsonb_build_object(
        'tenant', '',
        'searchindex', '',
        'name', 'create_accessholder',
        'status', 'success',
        'description', '',
        'action', 'create_accessholder',
        'entity', 'accessholder',
        'entityid', -1,
        'actor', p_actor_name,
        'metadata', p_params
