...
/*
---
title: Create importdata
description: Create a new importdata
keep: false
sensivity: private
gdpr: high
...
*/
CREATE OR REPLACE PROCEDURE proc.create_importdata(
...
BEGIN
    ...
    RETURNING id INTO p_id;
       ...
       p_auditlog_params := jsonb_build_object(
        'tenant', '',
        'searchindex', '',
        'name', 'create_importdata',
        'status', 'success',
        'description', '',
        'action', 'create_importdata',
        'entity', 'importdata',
        'entityid', -1,
        'actor', p_actor_name,
        'metadata', p_params
