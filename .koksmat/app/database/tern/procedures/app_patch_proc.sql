...
*/   
 ...
 CREATE OR REPLACE FUNCTION proc.patch_app(
...
BEGIN
    ...
    v_query := format('UPDATE public.app SET %s, updated_by = %L, updated_at = CURRENT_TIMESTAMP WHERE id = %L',
    ...
    IF v_rows_updated < 1 THEN
        RAISE EXCEPTION 'No records updated.  ID % not found in table app', p_id;
    END IF;
