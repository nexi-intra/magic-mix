...
import {ColumnSchema} from "../applogic/model";
...
export function ColumnForm(props : {column: ColumnItem,editmode:"create"|"update"}) {
    const {column,editmode} = props;
    function onSubmit(data: z.infer<typeof ColumnSchema>) {
        toast({
