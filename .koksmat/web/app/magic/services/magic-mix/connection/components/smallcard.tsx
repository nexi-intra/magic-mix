...
import {
  ...
  import ReadConnection from "./read";
  import UpdateConnection from "./update";

  export default function ConnectionSmallCard(props: {
    item: ConnectionItem;
    onClick?: () => void;
  }) {
    ...
    return (
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            {isViewing && (item.id>0) && <ReadConnection id={item.id} />}
          </SheetDescription>
        </SheetHeader>
      </SheetContent>
    </Sheet>
    ...
    <SheetContent>
      <SheetHeader>
        <SheetTitle>{item.name}</SheetTitle>
        <SheetDescription>
          {isEditing && (item.id>0) && <UpdateConnection id={item.id} />}
        </SheetDescription>
      </SheetHeader>
    </SheetContent>
  </Sheet>
