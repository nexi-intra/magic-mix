...
import {
  ...
  import ReadMapper from "./read";
  import UpdateMapper from "./update";

  export default function MapperSmallCard(props: {
    item: MapperItem;
    onClick?: () => void;
  }) {
    ...
    return (
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            {isViewing && (item.id>0) && <ReadMapper id={item.id} />}
          </SheetDescription>
        </SheetHeader>
      </SheetContent>
    </Sheet>
    ...
    <SheetContent>
      <SheetHeader>
        <SheetTitle>{item.name}</SheetTitle>
        <SheetDescription>
          {isEditing && (item.id>0) && <UpdateMapper id={item.id} />}
        </SheetDescription>
      </SheetHeader>
    </SheetContent>
  </Sheet>
